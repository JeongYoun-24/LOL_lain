let key ="RGAPI-07865a00-380a-4d8c-a8ca-0c95fa413d2b"
let puuid;
...
//https://kr.api.riotgames.com/lol/match/v5/matchlists/by-account/

function getSummonerRecentGameHistoryBySummonerAccountID(userInfo){
    $.ajax({
        url: "https://kr.api.riotgames.com/lol/match/v5/matches/"+userInfo.accountId,
        type: "GET",
        dataType: "json",
        data: {
            "api_key": key,
...
function loadSummonerMatchHistory(userInfo, info){
    ...
    for(let i=0;i<matchList.length;i++){
        ...
        let request = $.ajax({
            url: "https://kr.api.riotgames.com/lol/match/v5/matches/"+matchItemInfo.gameId,
            type: "GET",
            dataType: "json",
            data: {
                "api_key": key,
